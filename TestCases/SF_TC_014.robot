...
TEST CASE 010
    ...
    Login to SMARTFERN UI  ${SmartFern_CREDENTIAL}[username6]  ${SmartFern_CREDENTIAL}[password6]

    #Create Banner of Type External     TC_001   TD_01
    #Create Banner of Type Internal     TC_001   TD_02
    Sleep  15s
    Add Shedule To Banner of Type External   TC_001   TD_01
    Add Shedule To Banner of Type Internal     TC_001   TD_02
    Sleep  5s
    #Edit Banner of Type External       TC_001   TD_01
    #Edit Banner of Type Internal      TC_001   TD_02
